...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $sql = "INSERT INTO `Project` (projectName, startDate, endDate, projectDescription, status, UserUserID) VALUES ('$projectName', '$startDate', '$endDate', '$description', '$status', $userID)";
    $result = mysqli_query($connection,$sql);
    if($result){
        //displays ok sign
